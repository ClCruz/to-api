<?php
    ...
    function call($id_ticketoffice_user,$id_payment_type) {
        $query = "EXEC pr_ticketoffice_shoppingcart_delete ?,NULL,?";
        ...
        $params = array($id_ticketoffice_user,$id_payment_type);
...
call($_REQUEST["id_ticketoffice_user"],$_REQUEST["id_payment_type"]);
?>