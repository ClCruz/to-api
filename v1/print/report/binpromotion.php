...
<html>
   ...
   <table class="principal grid1">
         <tr style="font-weight: bold;font-size: 10px">
            ...
            <td style="text-align:right">Local da venda</td>
            <td style="text-align:right">Patrocinador</td>
         ...
         <?php foreach ($obj as &$row) {?>
            ...
            <td class="printonly_lines_values" style="text-align:left"><?php echo $row["buyer"] ?></td>
            ...
            <td class="printonly_lines_values" style="text-align:left"><?php echo $row["sellfrom"] ?></td>
            <td class="printonly_lines_values" style="text-align:left"><?php echo $row["sponsor"] ?></td>
