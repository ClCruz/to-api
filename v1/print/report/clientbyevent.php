<?php
   ...
   function get($id_base, $id_evento, $date, $hour) {
      if ($date != '' && $date != '') {
   ...
   $obj = get($_REQUEST["id_base"],$_REQUEST["id_evento"],$_REQUEST["date"],$_REQUEST["hour"]);
   ...
   if ($_REQUEST["exportto"]=="sheet") {
      ...
      header("Content-Disposition: attachment; filename=clientesporevento.xls");  //File name extension was wrong
      header("Expires: 0");
   ...
   <table class="principal">
      <tr>
         ...
         <td class="right-side-header">
            <span class="right-side-header-first">Clientes por evento</span>
         </td>
      </tr>
   </table>
   <table class="principal">
      <tr style="line-height: 10px;">
         <td style="text-align:center">
            ...
            <span class="value-info"><?php echo count($obj) ?></span>
         </td>
      </tr>
   </table>
