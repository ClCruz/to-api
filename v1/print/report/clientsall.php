<?php
   ...
   if ($_REQUEST["exportto"]=="sheet") {
      ...
      header("Content-Disposition: attachment; filename=clientesporparceiro.xls");  //File name extension was wrong
      header("Expires: 0");
   ...
   <table class="principal">
      <tr>
         ...
         <td class="right-side-header">
            <span class="right-side-header-first">Clientes por parceiro</span>
         </td>
      </tr>
   </table>
   <table class="principal">
